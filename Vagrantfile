Vagrant.configure(2) do |config|
    ...
    config.vm.define "www1" do |www1|
        ...
        www1.vm.network :forwarded_port, guest: 22, host: 2223, id: "ssh", disabled: true
    ...
    config.vm.define "www2" do |www2|
        ...
        www2.vm.network :forwarded_port, guest: 22, host: 2223, id: "ssh", disabled: true
    ...
    config.vm.define "rp" do |www2|
        ...
        www2.vm.network :forwarded_port, guest: 80, host: 9999, auto_correct: true
        p
    end
